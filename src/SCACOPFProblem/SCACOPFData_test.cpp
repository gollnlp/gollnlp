...
string computechecks(const SCACOPFData& d)
{
  ...
  chk=0.;
  for(auto& u: d.Lidxn1) for(auto& v: u) chk += (1+v)/16.0;
  for(auto& u: d.Lidxn2) for(auto& v: u) chk += (1+v)/16.0;
  ...
  chk=0.;
  for(auto& u: d.Tidxn1) for(auto& v: u) chk += (1+v)/16.0;
  for(auto& u: d.Tidxn2) for(auto& v: u) chk += (1+v)/16.0;
...
{
  vector<string> ret;
  ret.push_back("L_Nidx=1.40543e+04 T_Nidx=4.55162e+03 SSh_Nidx=2.21750e+02 G_Nidx=8.96750e+02 Lidxn=1.33691e+04 Tidxn=1.08075e+03 SShn=4.12500e+00 Gn=8.28750e+01");
  ret.push_back("L_Nidx=4.35477e+06 T_Nidx=1.88365e+06 SSh_Nidx=1.05403e+05 G_Nidx=5.04319e+03 Lidxn=4.95897e+06 Tidxn=4.84590e+05 SShn=6.37038e+03 Gn=1.01709e+04");
  ret.push_back("L_Nidx=4.35477e+06 T_Nidx=1.88365e+06 SSh_Nidx=1.05403e+05 G_Nidx=5.03806e+03 Lidxn=4.95897e+06 Tidxn=4.84590e+05 SShn=6.37038e+03 Gn=1.01353e+04");
  ret.push_back("L_Nidx=4.35477e+06 T_Nidx=1.88365e+06 SSh_Nidx=1.05403e+05 G_Nidx=5.04319e+03 Lidxn=4.95897e+06 Tidxn=4.84590e+05 SShn=6.37038e+03 Gn=1.01709e+04");
  ret.push_back("L_Nidx=3.95574e+04 T_Nidx=6.16244e+03 SSh_Nidx=1.19762e+03 G_Nidx=2.04469e+03 Lidxn=3.70081e+04 Tidxn=1.28700e+03 SShn=7.96875e+01 Gn=2.12688e+02");
  ret.push_back("L_Nidx=3.95574e+04 T_Nidx=6.16244e+03 SSh_Nidx=1.19762e+03 G_Nidx=2.39525e+03 Lidxn=3.70081e+04 Tidxn=1.28700e+03 SShn=7.96875e+01 Gn=2.73188e+02");
  ret.push_back("L_Nidx=3.01436e+05 T_Nidx=1.13911e+05 SSh_Nidx=8.01825e+03 G_Nidx=2.80622e+04 Lidxn=3.36545e+05 Tidxn=4.48910e+04 SShn=7.07812e+02 Gn=5.84550e+03");
  ret.push_back("L_Nidx=3.03972e+05 T_Nidx=1.40239e+05 SSh_Nidx=1.49339e+04 G_Nidx=1.78208e+04 Lidxn=2.90656e+05 Tidxn=4.59566e+04 SShn=1.26881e+03 Gn=1.96094e+03");
  ret.push_back("L_Nidx=3.01075e+05 T_Nidx=1.13911e+05 SSh_Nidx=8.01825e+03 G_Nidx=2.80622e+04 Lidxn=3.35965e+05 Tidxn=4.48910e+04 SShn=7.07812e+02 Gn=5.84550e+03");
  return ret;
}

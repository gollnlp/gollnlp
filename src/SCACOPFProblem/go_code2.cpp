...
bool MyCode2::_guts_of_solve_contingency(ContingencyProblemWithFixing& prob, int K_idx)
{
  ...
  //max time to spend in the contingency evaluation
  //it is NOT hard enforced
  double timeout = 1700.; 
  ...
  if(tm_percentage<0.075) {
    if(data.N_Bus.size()<31000) { //tm_percentage in [0%,7.5%]
      ...
      pen_accept = 1000.;
      pen_accept_inipt = 2500.;
      pen_accept_solve1 = 1500.;
    ...
    if(avgtm<1.9) {
      pen_accept = 1000;
      pen_accept_inipt = 2500.; 
      pen_accept_solve1 = 2000;
      pen_accept_emer = 4000.;
      pen_accept_safemode=50000.;
    } else if(avgtm<2.25) { //avgtm in [1.9, 2.25]
      pen_accept = 1500.; 
      pen_accept_inipt = 4000.;
      pen_accept_solve1 = 3000.;
      pen_accept_emer = 25000.;
    ...
    if(avgtm<1.90) {
      pen_accept = 5000.; pen_accept_inipt = 20000.; pen_accept_solve1 = 15000.;
      pen_accept_emer = 75000.; //75K
      pen_accept_safemode=10000000.;//10M
      timeout = 400;
    } else  { //avgtm > 1.9
      pen_accept = 75000.; pen_accept_inipt = 150000.; pen_accept_solve1 = 100000.;

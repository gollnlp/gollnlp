...
bool ACOPFProblem::
append_penalty_blocks(OptVariablesBlock* pg, const std::vector<int>& Gidxs)
{
...
bool ACOPFProblem::default_assembly()
{
  ...
  append_penalty_blocks(p_g, gens); 
  //append_objterm(new DummySingleVarQuadrObjTerm("p_g_sq", p_g));
  //append_objterm(new DummySingleVarQuadrObjTerm("p_g_sq2", p_g));

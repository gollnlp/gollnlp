		    ...
		    const std::string& NetworkModel)
{
  ...
  MyCode1Kron code1(InFile1, InFile2, InFile3, InFile4,
...
int main(int argc, char *argv[])
{
  ...
  std::cout << "MyExe1 - v. Oct 30, 2019 - 06:35PM" << std::endl;
#ifdef DEBUG
  ...
  if(argc==8) {
    ...
    MyCode1Kron code1(argv[3], argv[4], argv[2], argv[1], 
